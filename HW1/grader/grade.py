#!/usr/bin/env python3
"""HW1 autograder for the student release.

The released grader runs only the published public checks.
Private tests and their expected values are kept in TA tools only.
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run the released HW1 public grader.")
    parser.add_argument("--json", action="store_true", help="Print machine-readable JSON output.")
    parser.add_argument(
        "--public-only",
        action="store_true",
        help="Run only public tests (same as default for the student release).",
    )
